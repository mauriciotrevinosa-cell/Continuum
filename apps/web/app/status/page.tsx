...
/**
 * System status: bind address, profile, storage roots, vault protection and
 * providers. The studio itself opens at /; this page keeps the foundation
 * checks one click away.
 *
...
export default async function StatusPage() {
  ...
  return (
    <main>
      ...
      <h1>System status</h1>
      <p className="sub">
        The foundation under the studio: durable jobs, safe storage, local providers.
      </p>
