# The Arrivals — Abandoned Village + Inn Spatial Bible v0.4

**Status:** CREATOR-APPROVED SPATIAL PRODUCTION LOCK  
**Date:** 2026-09-19  
**Project:** `The Arrivals`  
**Branch:** `m3/critical-path`  
**Supersedes:** `THE_ARRIVALS_ABANDONED_VILLAGE_AND_INN_SPATIAL_BIBLE_v0.3.md`

This revision preserves the creator-approved settlement topology, dimensions, exterior identity, and growth phases from v0.3. It adds the measured ground-floor lock, the corrected upper-floor room order, and the stair/landing relationship approved on 2026-09-19.

For spatial production, v0.4 supersedes older prose, preliminary fit studies, and rejected generated interiors wherever they conflict. Generated CAL-02/CAL-03 interiors made before this lock are visual tests only and have no spatial authority. The approved exterior reference remains authoritative for the chimney/terrace architectural relationship.
...
`THE_ARRIVALS_INN_GROUND_FLOOR_MEASURED_PRODUCTION_PLAN_v0.1.md`
...
| Main stair run | `X 8.65–9.90`, `Y 15.35–20.55` | `1.25 × 5.20 m` | `6.5 m²` |
...
### 4.4 Main stair and corrected upper landing

- Stair width remains **1.25 m**, inside the approved 1.2–1.3 m range.
- The ground-floor footprint does not move.
- Ground access is at the **north end** of the stair footprint.
- The stair rises **south**.
- The upper landing is at the **south end** and opens west into the 1.8 m upper corridor.
- Approximate upper landing allowance: `X 7.55–10.10`, `Y 13.15–15.15`, **2.55 × 2.0 m**.
- This landing must never intervene between Frieren's room and her terrace.
- Full second floor is mandatory; there is no mezzanine or double-height tavern void.
...
| Stair void + south landing | `~11.6 m²` |
| Chimney stack | `~1.3 m²` |
| Preliminary partition allowance | `~22.0 m²` |
| Closets, vestibules and local fit margin | `~45.7 m²` |
...
### 5.5 Deferred measured detail

The room order, areas, corridor termination, chimney/terrace relationship, and stair/landing relationship are locked. **Exact upper-floor partition coordinates, door locations, door swings, closet geometry, and window-to-room assignment remain a later measured-detail pass.** Production must preserve the locked order while those details remain open.
