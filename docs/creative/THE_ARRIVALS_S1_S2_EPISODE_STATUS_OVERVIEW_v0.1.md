# The Arrivals — S1 / S2 Episode Status Overview v0.1

**Status:** CURRENT AUTHORITATIVE PRODUCTION-READINESS INDEX  
**Date:** 2026-09-14  
...
# Season 1 — locked structure

> **19 full episodes**

Sukuna's `Malevolent Shrine` reveal is the final sting inside S1E19, not a twentieth episode. The former separate G3-first-days and Road-Days concepts are fused/intercut inside E19.
...
Do not proactively rename episode titles the creator did not reject.

---

# Season 2 — current opening skeleton

The first approximately six S2 episodes have rough skeletons, not Level-4 scripts:
1. `Yuta Knows`
